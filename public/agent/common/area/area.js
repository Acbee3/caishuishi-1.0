function showLocation(province , city , town) {
	...
	$('#loc_province').change(function() {
        ...
        $('input[name=area_id]').val($('#loc_province').val());
	})
	...
	$('#loc_city').change(function() {
		...
		//$('input[@name=location_id]').val($(this).val());
        $('input[name=area_id]').val($('#loc_province').val() + ',' + $('#loc_city').val());
	})
	
	$('#loc_town').change(function() {
		//$('input[name=location_id]').val($(this).val());
        $('input[name=area_id]').val($('#loc_province').val() + ',' + $('#loc_city').val() + ',' + $('#loc_town').val());
	})
...
$(function(){
		showLocation(1226,1359,4846);//1,2,7
