...
function run() {
    ...
    commander
        ...
        .description([
            ...
            egIndent + 'node build/build.js --lang "my/lang.js" -i "my/indexTable.js" -o "my/bundle.js"'
                + '\n' + descIndent + '# Take `<cwd>/my/indexTable.js` as input and generate `<cwd>/my/bundle.js`,'
