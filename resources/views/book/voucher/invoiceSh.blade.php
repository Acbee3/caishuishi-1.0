            ...
            <div class="recoardMenu">
                ...
                <div class="recoardBar">
                    <div class="barMark">
                        ...
                        <input  :min="1" :max="10" step="1" type="number" v-model="numVal">
            ...
            methods: {
                ...
                getVoiceBook:function(){
                    ...
                    _this.$http.post('{{route('voucher.preview')}}',params).then(function(response){
                        ...
                        //console.log(_this.certificateTable)
                    });
                },
                /*--------获取数据-----*/
                getVoice:function(){
                ...
                condition:function(){
                    ...
                    var param = {
                        ...
                        'voucher_date':curData,'voucher_source':'14','total_debit_money':this.valTotal/100,
                        'total_credit_money':this.sendTotal/100,'total_cn':this.dxMoney,'items':data
                    };
                    return param;
                },
                /*--------借方的获取焦点-------*/
