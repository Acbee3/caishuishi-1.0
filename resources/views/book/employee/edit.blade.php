...
@section('css')
    ...
    <!--员工模块-->
    <link rel="stylesheet" href="{{asset("css/book/paid/newStaff.css")}}">
@endsection
        ...
        <form method="post">
            ...
            <div class="addLine">
                ...
                <div class="lineCenter">
                    ...
                    <div class="staff" ref="shareholder">
            ...
            <div class="newStaff-btn">
                <a href="javascript:void(0);" class="keepBtn" style="display: none;" >保存并新增</a>
                <a href="javascript:void(0);" class="keepBtn" @click="createPost" >保存</a>
...
<script>
    ...
    new Vue({
        ...
        data: {
            ...
            industryShow: false,
            getDocumentTypes:'{{\App\Models\Employee::Checkzjlx($info->zjlx)}}',
            getOverseas:'{{\App\Models\Employee::CheckCountry($info->country)}}',
            getOldChinese: '{{\App\Models\Employee::CheckYesOrNo($info->sf_cjlsgl)}}',
            getEmployees: '{{\App\Models\Employee::CheckYesOrNo($info->sf_employee)}}',
            getSex: '{{\App\Models\Employee::CheckSex($info->gender)}}',
            getPersonnel: '{{\App\Models\Employee::CheckStatus($info->status)}}',
            getShareholders: '{{\App\Models\Employee::CheckYesOrNo($info->sf_shareholder)}}',
            getIndustry: '{{\App\Models\Employee::CheckYesOrNo($info->sf_tdhy)}}',
            documentTypeOption:[
            ...
            employee_num:'{{$info->employee_num}}',
            remark:'{{$info->remark}}',
        ...
        methods:{
            ...
            createPost:function(){
                ...
                var new_birth = curData;
                if(new_birth.length <= 0){
                    new_birth = '{{$info->birthday}}';
                };
