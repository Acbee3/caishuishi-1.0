...
@section('content')
    <div class="receipts" v-cloak>
        <div class="formWrapper">
            <form class="layui-form receiptsMenu" id="query_form">
                <div class="receiptsMenuLeft">
                    ...
                    <div>
                        <select id="q_key" lay-filter="q_key" v-model="q_key">
                            ...
                            <option value="gfdw_name">购方名称</option>
                ...
                <div class="receiptsMenuRight">
                    <div class="receipts-invoice">
                        <a class="add_invoice_button" data-href="{{ url('/book/invoice/addExport')  }}" data-title="新增销项发票" href="javascript:;" onclick="top.Hui_admin_tab(this)">新增发票</a>
                    </div>
                    <div class="receipts-invoice">
        ...
        <div class="receiptsTable">
            ...
            <div>
                <div v-for="(invoice,index) in invoice_list" class="receiptsEach">
                                ...
                                <td colspan="7">
                                    <div class="receipts-tableTotal">
                                        ...
                                        <div class="receipts-tableInvoiceRight">
                                            ...
                                            <i class="icon iconfont tableEditor" @click="edit_invoice(invoice.id)">&#xe606;</i><!-- 编辑 -->
        ...
        var receipts = new Vue({
                ...
                created: function () {
                    layui.use('form', function () {
                        ...
                        if (receipts.q_key == 'fphm' || receipts.q_key == 'gfdw_name' || receipts.q_key == 'money' || receipts.q_key == 'remark') {
                ...
                methods: {
                    ...
                    edit_invoice: function (id) {
                        var url = '{{url('book/invoice/editExport')}}/' + id;
                        parent.creatIframe(url, '编辑销项发票-' + id);
                    },
                    ...
                    invoiceSummary: function () {
                        layer.open({
                            ...
                            maxmin: true, //开启最大化最小化按钮
                            area: ['893px', '600px'],
                            content: '{{ url('/book/invoice/summary')   }}?type={{ \App\Entity\Invoice::TYPE_EXPORT  }}'
                        });
                    },
