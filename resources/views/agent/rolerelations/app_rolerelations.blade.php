...
<head>
  ...
  <link rel="stylesheet" href="{{url("agent/common/css/agent/officer.css?v=2018082301")}}">
...
<script>
    $(".change_role").click(function(){
        ...
        var rto_href = "/agent/rolerelations/operation?id="+vid;
        window.location.href=rto_href;
    });
    $(".edit_role").click(function(){
        var vid = $(this).attr("vid");
        var rto_href = "/agent/rolerelations/edit?id="+vid;
        window.location.href=rto_href;
    });
    $(".del_role").click(function(){
        var vid = $(this).attr("vid");
        var rto_href = "/agent/rolerelations/del?id="+vid;
        window.location.href=rto_href;
    });
</script>
