                        ...
                        <form class="form-horizontal" method="post" action="?">
                            ...
                            <div class="box-body col-xs-6">
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}" >
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="name"  placeholder="代账公司名称" value="{{ $model->name}}" disabled>
                                        @if ($errors->has('name'))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('contacts') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="contacts"  placeholder="联系人" value="{{ old('contacts')? old('contacts'):$model->contacts}}">
                                ...
                                <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="phone"  placeholder="手机" value="{{ old('phone')? old('phone'):$model->phone}}">
                                        @if ($errors->has('phone'))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="address"  placeholder="联系地址" value="{{ old('address')? old('address'):$model->address}}">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <span class="btn red btn-outline btn-file">
                                                ...
                                                <input type="hidden" id="" name="pic" value="{{ old('pic')? old('pic'):$model->pic}}">
                                                <input type="file" name="..." class="file_buttom1">
                                            </span>
                                            </div>
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                                 style="width: 200px; height: 150px;">
                                                <img class="file_img" style="height: 140px;" src="{{ old('pic')? old('pic'):$model->pic}}">
                                            </div>
                                        </div>
                                        @if ($errors->has('pic'))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        @foreach(\App\Models\Agent::$statusLables as $key=>$v)
                                            <label><input type="radio" name="status" value="{{$key}}" @if($key==$model->status) checked @endif > {{$v}}</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        @endforeach
